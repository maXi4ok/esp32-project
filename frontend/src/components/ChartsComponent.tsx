...
const ChartsComponent = () => {
	...
	return (
		<div className="flex flex-col items-start mt-2 ml-2 w-[85%]">
			<p className="mb-1.5 font-[Inter] font-extrabold text-[#6d7278] text-[24px]">Graphs: </p>
