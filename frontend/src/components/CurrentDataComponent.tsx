...
const CurrentDataComponent = () => {
	...
	return (
		<div className="bg-[#e5e5e5] m-5 rounded-[10px] w-[85%] h-42">
			<p className="mt-2 ml-3 font-[Inter] font-extrabold text-[#6d7278] text-[24px]">Curret Data:</p>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]">Temperature: <span className="text-[#fca311]">{currentData?.temp ? currentData.temp : 'no_data'}°C</span></p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]">Humidity: <span className="text-[#1e3057]">{currentData?.humid ? currentData.humid : 'no_data'}%</span> </p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]" title="Час останнього запису" >Time: <span className="text-black">{currentData?.time ? currentData.time : 'no_data'}</span></p>
			</div>
		</div>
	);
};
