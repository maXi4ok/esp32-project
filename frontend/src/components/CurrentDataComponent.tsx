...
const CurrentDataComponent = () => {
	...
	return (
		<div className="bg-[#e5e5e5] m-5 rounded-[10px] w-[85%] h-42">
			<p className="mt-2 ml-3 font-[Inter] font-extrabold text-[#6d7278] text-[24px]">Поточні Дані:</p>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]">Температура: <span className="text-[#fca311]">{currentData?.temp ? currentData.temp : 'not_found'}°C</span></p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]">Вологість: <span className="text-[#1e3057]">{currentData?.humid ? currentData.humid : 'not_found'}%</span> </p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[#6d7278] text-[23px]" title="Час останнього запису" >Час: <span className="text-black">{currentData?.time ? currentData.time : 'not_found'}</span></p>
			</div>
		</div>
	);
};
