...
const CurrentDataComponent = () => {
	...
	return (
		<div className="bg-[#e5e5e5] w-[85%] h-42 rounded-[10px] m-5">
			<p className="font-[Inter] font-extrabold text-[24px] text-[#6d7278] ml-3 mt-2">Current:</p>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[24px] text-[#6d7278]">Temperature: <span className="text-[#fca311]">{currentData?.temp ? currentData.temp : 'not_found'}°C</span></p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[24px] text-[#6d7278]">Humidity: <span className="text-[#1e3057]">{currentData?.humid ? currentData.humid : 'not_found'}%</span> </p>
			</div>
			<div className="flex flex-row">
				...
				<p className="ml-2 font-[Inter] font-extrabold text-[24px] text-[#6d7278]" >Time: <span className="text-black">{currentData?.time ? (new Date(currentData.time).getHours().toString() + ":" + new Date(currentData.time).getMinutes().toString()) : 'not_found'}</span></p>
			</div>
		</div>
	);
};
